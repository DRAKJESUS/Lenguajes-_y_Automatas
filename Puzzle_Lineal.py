...
def buscar_solucion_BFS(estado_inicial, solucion):
    ...
    while(not solucionado) and len(nodos_frontera) != 0:
        ...
        if nodo.get_datos() == solucion:
            ...
            dato_nodo = nodo.get_datos() # Estamos referenciando a un metodo que no teniamos en Arbol.py
...
def imprimir():
    ...
    resultado = []
    nodo = nodo_solucion
    while nodo.get_padre() != None: # Aqui tenemos al metodo get_padre sin los parentesis que llevan los metodos o funciones
